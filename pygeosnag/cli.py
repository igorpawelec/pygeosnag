...
def _detect(a):
    ...
    n = detect(a.raster, a.output, mode=a.mode, bands=bands, threshold=a.threshold, suppress_m=a.suppress,
               ...
               chm=a.chm, dtm=a.dtm, dsm=a.dsm, min_height=a.min_height, height_radius=a.height_radius,
               keep_low=a.keep_low,
               ...
               scene_norm=a.scene_norm, norm_tiles=a.norm_tiles, radiometry=a.radiometry, quiet=a.quiet)
...
def _grow(a):
    ...
    grow_crowns(a.raster, a.points, a.output, mode=a.mode, bands=bands, labels_out=a.labels,
                ...
                fill_holes=not a.no_fill_holes, tile=a.tile, workers=a.workers, space=a.space, quiet=a.quiet)
    return 0
...
def main(argv=None):
    ...
    d.add_argument("--min-height", type=float, default=3.0, help="height gate in metres (default 3)")
    d.add_argument("--height-radius", type=float, default=3.0,
                   help="the height of a point is the maximum within this radius, m (default 3)")
    ...
    g.add_argument("--space", choices=["lab_w", "lab", "ndvi_L", "raw"], default="lab_w",
                   help="feature space of the growing (default lab_w, the shipped recipe; ndvi_L grew the best crowns on the benchmark, needs NIR)")
